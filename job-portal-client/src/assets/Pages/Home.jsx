...
const Home = () => {
  ...
  const handleSearch = () => {
    ...
    if (jobTitle.trim() !== "") {
      query += `title=${encodeURIComponent(jobTitle)}`;
    }
    ...
    navigate(query ? `/jobList?${query}` : "/jobList");
  };
          ...
          <div className="relative z-10 flex flex-col md:flex-row items-center justify-between px-8 md:px-16 py-12">
            ...
            <div className="max-w-xl">
              ...
              <div className="mt-6 bg-white rounded-xl flex flex-col md:flex-row items-center shadow-lg overflow-hidden justify-center gap-3">
                ...
                <button
                  className="w-full md:w-auto bg-gradient-to-r from-purple-500 to-indigo-500 px-4 py-2 rounded-lg font-semibold text-white bg-[linear-gradient(127deg,#897BFF_0%,#4A37F3_100%)] hover:opacity-90 mr-3"
              ...
              <div className="mt-4">
                ...
                <div className="flex flex-wrap gap-2 mt-2">
                  {["All jobs", "Developer", "Finance", "Health care"].map(
                    (tag, i) => (
                      <span
                        key={i}
